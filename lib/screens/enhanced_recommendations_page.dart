...
class _EnhancedRecommendationsPageState
  ...
  void initState() {
    ...
    // _recommendationService.initialize est maintenant appelé dans _loadData
    _loadData();
  }

  Future<void> _loadData() async {
    try {
      await _recommendationService.initialize(preferences: widget.userPreferences);
      ...
      _recommendations = await _recommendationService.getEnhancedRecommendations(
        _allDestinations,
        limit: 20,
      );
  ...
  void _recordInteraction(String destinationId, InteractionType type) async {
    await _recommendationService.recordInteraction(destinationId, type);
    if (mounted) {
      setState(() {});
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // final activities = ... (moved to FutureBuilder)
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FutureBuilder<List<Activity>>(
                      future: _activityAnalyzer.getActivitiesForDestination(destination.name),
